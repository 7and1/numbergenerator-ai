...
import ComboPageContent from "./ComboGeneratorClient";
...
export default function ComboPage() {
  return (
    <main
      ...
      aria-labelledby="combo-page-heading"
    >
      <div className="max-w-4xl mx-auto">
        {/* Breadcrumb Navigation */}
        <nav className="mb-6" aria-label="Breadcrumb">
          <Breadcrumbs items={PAGE_BREADCRUMBS["/combo"]} />
        </nav>

        <ComboPageContent />

        {/* SEO Content */}
        <article className="mt-16 pt-8 border-t border-zinc-200 dark:border-zinc-800">
          <h2
            id="combo-page-heading"
            className="text-2xl font-bold tracking-tight mb-4"
          >
            About the Combination Generator
          </h2>
          <p className="text-zinc-600 dark:text-zinc-400 mb-4">
            The Combination Generator allows you to run multiple random
            generators simultaneously with a single click. Perfect for game
            nights, classroom activities, or any situation where you need
            multiple random values at once.
          </p>
          ...
          <div className="mt-8 rounded-2xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-900 p-6">
            ...
            <p className="text-sm text-emerald-700 dark:text-emerald-400">
              All generation happens locally in your browser using Web Crypto
              API (CSPRNG). Your data never leaves your device. No tracking, no
